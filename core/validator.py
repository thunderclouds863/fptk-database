...
def build_friendly_header_error(
    ...
    return {
        ...
        "solution": (
            ...
            "2. Cek baris pertama (header) - pastikan nama kolomnya sesuai\n"
            "3. Kalau ada typo, perbaiki nama kolomnya\n"
...
def validate_fptk_file(
    ...
    for idx, row in df.iterrows():
        ...
        if kode_angka is None or pd.isna(kode_angka) or str(kode_angka).strip() == "":
            errors.append({
                "row": row_num,
                "field": "Kode Angka (ID)",
                "value": kode_angka,
                    ...
                    if 1 <= num <= 5:
                        ...
                        if suggested != level_str:
                            errors.append({
                                ...
                                "expected": "Level FPTK harus: 1A-5C"
                            })
                    else:
                        errors.append({
                            "row": row_num,
